...
<form action="#" th:action="@{/${package.ModuleName}/${table.name}}"  method="post">
			...
			<fieldset class="layui-elem-field">
				...
				<div class="layui-field-box">
					...
					<div class="cl pd-5 bg-1 bk-gray">
						<span class="l">
						<a href="javascript:;" onclick="deleteAll('/${package.ModuleName}/${table.name}/deleteAll')"  class="layui-btn  layui-btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
						<a href="javascript:;" onclick="layer_show('添加','/${package.ModuleName}/${table.name}/addBefore',800,300)" class="layui-btn  layui-btn-normal radius"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
						</span>
					...
					<table class="layui-table text-c">
						...
						<tr class="text-c" th:each="${table.name},count:${r"${pageInfo.list}"}">
							...
							<td class="td-manage">
								<a title="编辑" href="javascript:;" th:onclick="'javascript:layer_show(\'编辑\',\'/${package.ModuleName}/'+'${table.name}'+'/editBefore/'+${r"${"}test${r".id}"}+'\',800,300)'" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
								<a title="删除"    href="javascript:;" th:onclick="'javascript:deleteById(\'/${package.ModuleName}/'+'${table.name}'+'/delete/'+${r"${"}test${r".id}"}+'\')'" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
							</td>
						</tr>
						</tbody>
					</table>
